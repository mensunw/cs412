...
urlpatterns = [
  ...
  path('profile/friend_suggestions', views.ShowFriendSuggestionsView.as_view(), name="suggest_friends"),
  path('profile/news_feed', views.ShowNewsFeedView.as_view(), name="show_feed"),
